package com.khaled_amin.book_social_network.role.api.mapper;
...
import com.khaled_amin.book_social_network.role.api.dto.CreateRoleRequest;
import com.khaled_amin.book_social_network.role.api.dto.RoleResponse;
import com.khaled_amin.book_social_network.role.api.dto.UpdateRoleRequest;
...
//    }
//
//    default UpdateRoleCommand toCommand(UpdateRoleRequest request) {
//        if (request == null) {
//            return null;
//        }
//
//        return UpdateRoleCommand.of(
//                request.getDisplayName(),
//                request.getDescription(),
//                request.getDefaultRole(),
//                request.getProtectedRole()
