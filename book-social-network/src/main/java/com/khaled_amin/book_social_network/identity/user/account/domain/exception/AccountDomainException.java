...
public class AccountDomainException extends IdentityException {
    ...
    public static AccountDomainException samePassword() {
        return of(AccountDomainError.INVALID_NEW_PASSWORD);
    }
}