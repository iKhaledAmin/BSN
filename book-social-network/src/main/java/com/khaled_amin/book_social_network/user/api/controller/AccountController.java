...
import com.khaled_amin.book_social_network.user.api.dto.*;
...
public class AccountController {
    ...
    public ResponseEntity<ApiResponse<AccountNormalResponse>> register(
        ...
        AccountCreateCommand command = accountNormalMapper.toCommand(request);
        Account account = accountService.register(command);
